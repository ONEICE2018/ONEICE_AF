...
void MainWindow::callcurvefitting()
{
    on_ac_curve_fitting_clicked();
}
...
//    ana_init();
    mainUiInit();
    datainit_all();
    ui->widget_disable_without_download->setVisible(false);
    on_con2stm_clicked();
...
void MainWindow::dosubmit()
{
    ...
    if(DCenablemap.value(submit_remote     ))
    {
        DCconsend("SYSTem:REMote"                                                                   );
        dcsubmit(false, submit_remote, "0");
        QThread::msleep(5);
    }
    if(DCenablemap.value(submit_local      ))
    {
        DCconsend("SYSTem:LOCal"                                                                    );
        dcsubmit(false, submit_local, "0");
        QThread::msleep(5);
    }
    if(DCenablemap.value(submit_ALLOut_ON  ))
    {
        DCconsend("OUTPut ON"                                                                       );
        dcsubmit(false, submit_ALLOut_ON, "0");
        QThread::msleep(5);
    }
    if(DCenablemap.value(submit_ALLOut_OFF ))
    {
        DCconsend("OUTPut OFF"                                                                      );
        dcsubmit(false, submit_ALLOut_OFF, "0");
        QThread::msleep(5);
    }
    if(area == 1)if(DCenablemap.value(submit_CH1Vset    ))
        {
            DCconsend(QString("VOLTage %1V"       ).arg(DCvaluemap.value(submit_CH1Vset    )));
            dcsubmit(false, submit_CH1Vset, "0");
            QThread::msleep(5);
        }
    if(area == 1)if(DCenablemap.value(submit_CH1Iset    ))
        {
            DCconsend(QString("CURR %1A"          ).arg(DCvaluemap.value(submit_CH1Iset    )));
            dcsubmit(false, submit_CH1Iset, "0");
            QThread::msleep(5);
        }
    if(area == 1)if(DCenablemap.value(submit_CH1Out     ))
        {
            DCconsend(QString("CHANnel:OUTPut %1" ).arg(DCvaluemap.value(submit_CH1Out     )));
            dcsubmit(false, submit_CH1Out, "0");
            QThread::msleep(5);
        }
    if(area == 1)if(DCenablemap.value(submit_CH1Vstep   ))
        {
            DCconsend(QString("VOLTage:STEP %1V"  ).arg(DCvaluemap.value(submit_CH1Vstep   )));
            dcsubmit(false, submit_CH1Vstep, "0");
            QThread::msleep(5);
        }
    if(area == 1)if(DCenablemap.value(submit_CH1Vstep_u ))
        {
            DCconsend(QString("VOLTage:UP"        ).arg(DCvaluemap.value(submit_CH1Vstep_u )));
            dcsubmit(false, submit_CH1Vstep_u, "0");
            QThread::msleep(5);
        }
    if(area == 1)if(DCenablemap.value(submit_CH1Vstep_d ))
        {
            DCconsend(QString("VOLTage:DOWN"      ).arg(DCvaluemap.value(submit_CH1Vstep_d )));
            dcsubmit(false, submit_CH1Vstep_d, "0");
            QThread::msleep(5);
        }
    if(area == 1)if(DCenablemap.value(submit_CH1Istep   ))
        {
            DCconsend(QString("CURRent:STEP %1A"  ).arg(DCvaluemap.value(submit_CH1Istep   )));
            dcsubmit(false, submit_CH1Istep, "0");
            QThread::msleep(5);
        }
    if(area == 1)if(DCenablemap.value(submit_CH1Istep_u ))
        {
            DCconsend(QString("CURRent:UP"        ).arg(DCvaluemap.value(submit_CH1Istep_u )));
            dcsubmit(false, submit_CH1Istep_u, "0");
            QThread::msleep(5);
        }
    if(area == 1)if(DCenablemap.value(submit_CH1Istep_d ))
        {
            DCconsend(QString("CURRent:DOWN"      ).arg(DCvaluemap.value(submit_CH1Istep_d )));
            dcsubmit(false, submit_CH1Istep_d, "0");
            QThread::msleep(5);
        }
    if(area == 2)if(DCenablemap.value(submit_CH2Vset    ))
        {
            DCconsend(QString("VOLTage %1V"       ).arg(DCvaluemap.value(submit_CH2Vset    )));
            dcsubmit(false, submit_CH2Vset, "0");
            QThread::msleep(5);
        }
    if(area == 2)if(DCenablemap.value(submit_CH2Iset    ))
        {
            DCconsend(QString("CURR %1A"          ).arg(DCvaluemap.value(submit_CH2Iset    )));
            dcsubmit(false, submit_CH2Iset, "0");
            QThread::msleep(5);
        }
    if(area == 2)if(DCenablemap.value(submit_CH2Out     ))
        {
            DCconsend(QString("CHANnel:OUTPut %1" ).arg(DCvaluemap.value(submit_CH2Out     )));
            dcsubmit(false, submit_CH2Out, "0");
            QThread::msleep(5);
        }
    if(area == 2)if(DCenablemap.value(submit_CH2Vstep   ))
        {
            DCconsend(QString("VOLTage:STEP %1V"  ).arg(DCvaluemap.value(submit_CH2Vstep   )));
            dcsubmit(false, submit_CH2Vstep, "0");
            QThread::msleep(5);
        }
    if(area == 2)if(DCenablemap.value(submit_CH2Vstep_u ))
        {
            DCconsend(QString("VOLTage:UP"        ).arg(DCvaluemap.value(submit_CH2Vstep_u )));
            dcsubmit(false, submit_CH2Vstep_u, "0");
            QThread::msleep(5);
        }
    if(area == 2)if(DCenablemap.value(submit_CH2Vstep_d ))
        {
            DCconsend(QString("VOLTage:DOWN"      ).arg(DCvaluemap.value(submit_CH2Vstep_d )));
            dcsubmit(false, submit_CH2Vstep_d, "0");
            QThread::msleep(5);
        }
    if(area == 2)if(DCenablemap.value(submit_CH2Istep   ))
        {
            DCconsend(QString("CURRent:STEP %1A"  ).arg(DCvaluemap.value(submit_CH2Istep   )));
            dcsubmit(false, submit_CH2Istep, "0");
            QThread::msleep(5);
        }
    if(area == 2)if(DCenablemap.value(submit_CH2Istep_u ))
        {
            DCconsend(QString("CURRent:UP"        ).arg(DCvaluemap.value(submit_CH2Istep_u )));
            dcsubmit(false, submit_CH2Istep_u, "0");
            QThread::msleep(5);
        }
    if(area == 2)if(DCenablemap.value(submit_CH2Istep_d ))
        {
            DCconsend(QString("CURRent:DOWN"      ).arg(DCvaluemap.value(submit_CH2Istep_d )));
            dcsubmit(false, submit_CH2Istep_d, "0");
            QThread::msleep(5);
        }
    if(area == 3)if(DCenablemap.value(submit_CH3Vset    ))
        {
            DCconsend(QString("VOLTage %1V"       ).arg(DCvaluemap.value(submit_CH3Vset    )));
            dcsubmit(false, submit_CH3Vset, "0");
            QThread::msleep(5);
        }
    if(area == 3)if(DCenablemap.value(submit_CH3Iset    ))
        {
            DCconsend(QString("CURR %1A"          ).arg(DCvaluemap.value(submit_CH3Iset    )));
            dcsubmit(false, submit_CH3Iset, "0");
            QThread::msleep(5);
        }
    if(area == 3)if(DCenablemap.value(submit_CH3Out     ))
        {
            DCconsend(QString("CHANnel:OUTPut %1" ).arg(DCvaluemap.value(submit_CH3Out     )));
            dcsubmit(false, submit_CH3Out, "0");
            QThread::msleep(5);
        }
    if(area == 3)if(DCenablemap.value(submit_CH3Vstep   ))
        {
            DCconsend(QString("VOLTage:STEP %1V"  ).arg(DCvaluemap.value(submit_CH3Vstep   )));
            dcsubmit(false, submit_CH3Vstep, "0");
            QThread::msleep(5);
        }
    if(area == 3)if(DCenablemap.value(submit_CH3Vstep_u ))
        {
            DCconsend(QString("VOLTage:UP"        ).arg(DCvaluemap.value(submit_CH3Vstep_u )));
            dcsubmit(false, submit_CH3Vstep_u, "0");
            QThread::msleep(5);
        }
    if(area == 3)if(DCenablemap.value(submit_CH3Vstep_d ))
        {
            DCconsend(QString("VOLTage:DOWN"      ).arg(DCvaluemap.value(submit_CH3Vstep_d )));
            dcsubmit(false, submit_CH3Vstep_d, "0");
            QThread::msleep(5);
        }
    if(area == 3)if(DCenablemap.value(submit_CH3Istep   ))
        {
            DCconsend(QString("CURRent:STEP %1A"  ).arg(DCvaluemap.value(submit_CH3Istep   )));
            dcsubmit(false, submit_CH3Istep, "0");
            QThread::msleep(5);
        }
    if(area == 3)if(DCenablemap.value(submit_CH3Istep_u ))
        {
            DCconsend(QString("CURRent:UP"        ).arg(DCvaluemap.value(submit_CH3Istep_u )));
            dcsubmit(false, submit_CH3Istep_u, "0");
            QThread::msleep(5);
        }
    if(area == 3)if(DCenablemap.value(submit_CH3Istep_d ))
        {
            DCconsend(QString("CURRent:DOWN"      ).arg(DCvaluemap.value(submit_CH3Istep_d )));
            dcsubmit(false, submit_CH3Istep_d, "0");
            QThread::msleep(5);
        }
